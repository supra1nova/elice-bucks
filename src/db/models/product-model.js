...
export class ProductModel {
  ...
  // 4. _id 기준 조회 - product 스키마의 _id를 이용해 조회한 뒤, populate를 통해 'category'로 등록된 ref를 찾아 name 값을 가져옴
  ...
  // 5. 카테고리 기준 제품 조회 - product 스키마의 categoryId를 이용해 조회한 뒤, 'category'로 등록된 ref를 찾아 name 값을 가져옴
